...
export default function JobsList({jobs, currentUser, title = "find your dream job", subtitle = " jobs that will suit you"}: {jobs: jobWithCompanyWIthJobsWithUsers[], currentUser: UserWithNotApp, title?: string, subtitle?: string}) {
  return (
