...
export default function JobsList({jobs, currentUser, title = "find your dream job", subtitle = " jobs that will suit you"}: {jobs: Job[], currentUser: User, title?: string, subtitle?: string}) {
  return (
