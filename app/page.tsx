  ...
  return (
    <ClientOnly>
      <div className='flex flex-col gap-2'>
       ...
       <JobsList jobs={jobs} currentUser={currentUser} title={currentUser.role === UserRole.JOB_SEEKER ? undefined : "Your Jobs"} showButton={false} subtitle={currentUser.role === UserRole.JOB_SEEKER ? undefined : "Your posted jobs"} url='/'  />
     </div>
    </ClientOnly>
  )
}
